/* $Header: /cvs/master/quadrics/elan4lib/minfo/mpi_interface.h,v 1.2 2007/04/25 14:23:35 ashley Exp $ */
/* $Locker:  $ */

/**********************************************************************
 * Copyright (C) 2007 Quadrics Ltd.
 *
 ...
 *				  DISCLAIMER
 *
 * Neither Quadrics, nor any of their employees, makes any warranty
 ...
 * Ashley Pittman: Quadrics Ltd. <ashley@quadrics.com>
 **********************************************************************/
...
/* Update log
 *
 * Apr 25 2007 AMP: Add a call to extract current state of MPI-1 collective
                operations.
 ...
 *
 * Ashley Pittman April 2007, ashley@quadris.com
 */

/*
 * Return the state of collective operations for the currently active
 * communicator, that is the number of times the colletive has been
